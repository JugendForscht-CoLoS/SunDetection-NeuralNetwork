...
#Methode zum Visualieren von Bildern
...
#Ausgabe des Verhalten der Loss-Function visualieren
plt.figure()
...
model.save_weights('neuralnet/saved_weights') #neuronales Netz speichern
